      ...
      <div className="container offer-wrap">
        <Reveal className="offer-copy">
          ...
          <div className="value-invoice-stack">
            {offerDeliverables.map((item) => {
              const Icon = item.icon;
              return (
                <div className="invoice-row" key={item.name}>
                  <Icon className="invoice-icon" strokeWidth={1.7} />
                  <div className="invoice-row-content">
                    <h4>{item.name}</h4>
                    <p>{item.description}</p>
                  </div>
                  <div className="invoice-row-price">
                    <span>{item.highlight ? "Principal" : "Incluso"}</span>
                  </div>
                </div>
              );
            })}
        ...
        <Reveal className="price-card" delay={0.08}>
          ...
          <div className="price-total-original">
            ...
            <span className="price-slashed-total">R$ {totalValue}</span>
          </div>
